	...
	*/
	...
	var pushData = function (infoObj) {
		...
		if (infoObj['type'] == "introduction") {
			...
			var linesUsername = "<div class='lines username'> <label><?php print $_language->text('username', 'ucfirst'); ?></label> <div><input class='input username' type='text' placeholder='<?php print $_language->text('username', 'ucfirst'); ?>' disabled='disabled'></div> </div>";
			var linesName = "<div class='lines name'> <label><?php print $_language->text('name', 'ucfirst'); ?></label> <div><input class='input fullname' type='text' placeholder='<?php print $_language->text('fullname', 'ucfirst'); ?>' disabled='disabled'></div> <div><input class='input firstname' type='text' placeholder='<?php print $_language->text('firstname', 'ucfirst'); ?>'> <input class='input middlename' type='text' placeholder='<?php print $_language->text('middlename', 'ucfirst'); ?>'> <input class='input lastname' type='text' placeholder='<?php print $_language->text('lastname', 'ucfirst'); ?>'></div> </div>";
			// var linesName = "<div class='lines name'> <label><?php print $_language->text('name', 'ucfirst'); ?></label> <div><input class='input fullname' type='text' placeholder='<?php print $_language->text('fullname', 'ucfirst'); ?>' disabled='disabled'></div> </div>" + "<div class='rows firstname odd'> <label class='none'><?php print $_language->text('firstname', 'ucfirst'); ?></label> <div><input class='input firstname' type='text' placeholder='<?php print $_language->text('firstname', 'ucfirst'); ?>'></div> </div>" + "<div class='rows lastname'> <label class='none'><?php print $_language->text('lastname', 'ucfirst'); ?></label> <div><input class='input lastname' type='text' placeholder='<?php print $_language->text('lastname', 'ucfirst'); ?>'></div> </div>";
			mainBox.append(linesUsername).append(linesName);
			mainBox.hide().fadeIn();
	...
	var getData = function (object) {
		...
		if (tab.attr('handling-data') != "true") {
			if (object['rows'] == "introduction") {
				...
				var rowsObj = ['username', 'fullname', 'firstname', 'middlename', 'lastname', 'nickname', 'formatname', 'gender', 'birthday', 'birthday.format', 'language'];
