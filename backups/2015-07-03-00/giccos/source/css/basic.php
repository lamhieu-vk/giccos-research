...
#popupNotification > .tab > .title i._t4 {
	color: #F27F10;
}
#popupNotification > .tab > .title i._t4:before {
	content: "\f071";
}
...
#userInfoEditor > .boxContent > .body .main > .lines.name .input.middlename,
#userInfoEditor > .boxContent > .body .main > .lines.name .input.lastname {
	width: 24.60%;
  	margin: 5px 2px 0 0;
}
#userInfoEditor > .boxContent > .body .main > .lines.name .input.firstname {
