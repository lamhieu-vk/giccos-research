...
$checkCookie = (isset($_COOKIE['gCID'], $g_cache['readfile'][$fileID]) && $_COOKIE['gCID'] == $g_cache['readfile'][$fileID]);
if ((!$pageUpdated || $checkID) && $checkCookie) {
	header('HTTP/1.1 304 Not Modified');
	header('Connection: close');
	die();
}else {
	$g_cache['readfile'][$fileID] = $_COOKIE['gCID'];
	$_SESSION["cache"]['readfile'][$fileID] = $g_cache['readfile'][$fileID];
