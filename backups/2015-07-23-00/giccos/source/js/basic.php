...
var reopenMessagesTabPrivate = function () {
	/*
	if (getCookie("gMessagesTabPos") == "null") {
		removeCookie("gMessagesTabPos");
	}
	if (isset(getCookie("gMessagesTabPos")) && typeof getCookie("gMessagesTabPos") == "string") {
		var posObj = getCookie("gMessagesTabPos");
			...
			if (isset(popupPosObj) && countArr(popupPosObj) == 2) {
				...
				if (isset(tokenCookie) && tokenCookie == "<?php print $_client->client(); ?>") {
					if (isset(objCookie) && typeof objCookie == "object" && countArr(objCookie) > 0 && objCookie !== null) {
						...
						writeCookie("gMessagesTabPos", JSON.stringify([tokenCookie, objCookie]), 604800);
					}else {
						removeCookie("gMessagesTabPos");
					}
				}else {
