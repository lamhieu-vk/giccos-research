							...
							if ($wall_['tab'] == "about") {
								...
								if (isset($wall_['about']['gender']) && $wall_['about']['gender'] != null) {
									...
									<div class='value to'>
										...
										<div class='textmain'><span>{$_language->text('gender_'.$wall_['about']['gender'], 'ucfirst')}</span></div>
									</div>
									";
								}
								if (isset($wall_['about']['interest']) && $wall_['about']['interest'] != null) {
									...
									<div class='value to'>
										...
										<div class='textmain'><span>{$_language->text('gender_'.$wall_['about']['interest'], 'ucfirst')}</span></div>
									</div>
									";
								}
