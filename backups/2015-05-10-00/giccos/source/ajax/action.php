...
if (isset($g_client['token']['ajax'], $g_client['token']['action']['key']['cookie'], $_SERVER['HTTP_RANDKEY'], $_SERVER['HTTP_TOKEN'], $_SERVER['HTTP_X_REQUESTED_WITH'], $_SERVER['HTTP_REFERER'], $_SERVER['HTTP_HOST']) && $_SERVER['HTTP_TOKEN'] == $g_client['token']['ajax'] && $_SERVER['HTTP_X_REQUESTED_WITH'] == "XMLHttpRequest" && $_tool->valueCheck("referer", $_SERVER['HTTP_REFERER']) && $_SERVER['HTTP_HOST'] == $_tool->links("::host") && $g_client['token']['action']['key']['cookie'] == $_COOKIE[$_SERVER['HTTP_RANDKEY']]) {
