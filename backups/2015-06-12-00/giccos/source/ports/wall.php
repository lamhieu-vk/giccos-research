									...
									if (is_numeric($wall_['about']['live'])) {
										...
										if ($placesLivingMapsDataCheck == 1) {
											...
											if (isset($wall_['about']['live.code']) && $wall_['about']['live.code'] != null) {
												...
												if (isset($placesLivingMapsData['return'], $placesLivingMapsData['data'][0]) && $placesLivingMapsData['return'] == true) {
													$placesLivingMapsData['data'] = $placesLivingMapsData['data'][0];
													$codeInfoTab['places'] .= "
													<div class='value to'>
														...
														<div class='imgMaps'><div class='img' style='background-image: url(".preg_replace("/(markers\=color\:red)/", "markers=color:gray", preg_replace("/(zoom=15)/", "zoom=14", preg_replace("/(400x400)/", "324x248", $placesLivingMapsData['data']['thumbnail']))).");' alt='{$placesLivingMapsData['data']['name']} - {$placesLivingMapsData['data']['address']}'></div></div>
													</div>
													";
												}else {
													//.
