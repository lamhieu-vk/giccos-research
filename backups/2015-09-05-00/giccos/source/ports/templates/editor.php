		...
		<div class="footer">
			<div class="push">
				...
				<div class="button private">
					...
					<div class="view _tt-bk s" editor-push="private" private="<?php print $privateView; ?>" title="<?php print $_language->text('change_view_private', 'ucfirst'); ?>"></div>
					<div class="comment _tt-bk s" editor-push="private" private="<?php print $privateComment; ?>" title="<?php print $_language->text('change_comment_private', 'ucfirst'); ?>"></div>
					<div class="share _tt-bk s" editor-push="private" private="<?php print $privateShare; ?>" title="<?php print $_language->text('change_share_private', 'ucfirst'); ?>"></div>
					<?php
