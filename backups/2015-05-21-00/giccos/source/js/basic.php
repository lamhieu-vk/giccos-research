...
var messagesTabPrivate = function (object) {
	...
	//.
	var messagesTabCode = "<div class='messagesTab' display='"+messagesTabDisplay+"'> <div class='title'> <div class='name'> <i></i> <span>Name</span> </div> <div class='options'> <div class='close'><i class='icon'></i></div> </div> </div> <div class='content'> <br><br><br> </div> </div>";
...
$(document).ready(function(){
	...
	setTimeout(function(){
		...
		direct();
		pushInfoEr();
		messagesTabPrivate({'display': 'xxx'});
