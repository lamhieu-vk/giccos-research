<?php
$getGuy = $_media->guy(array("author.type" => $dataFile['author.type'], "author.id" => $dataFile['author.id'], "guy.type" => $g_user['mode']['type'], "guy.id" => $g_user['mode']['id']));
					...
					<div id="viewBox" class="boxGrid boxContent">
						...
						<div class="content">
							<div class="imgDisplay">
								<img class="imgSrcThumbnail" src="<?php print $dataFile['path.medium']; ?>">
							</div>
						</div>
					</div>
