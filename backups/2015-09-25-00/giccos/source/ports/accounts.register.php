					...
					<div id="registerBox" class="box">
						...
						<div class="body">
							...
							<div class="lines birthday" box-steps="2">
								...
								<div>
									<input class="input birthday day" date-type="day" type="text" placeholder="<?php print $_language->text('day', 'strtolower'); ?>">
									<input class="input birthday month" date-type="month" type="text" placeholder="<?php print $_language->text('month', 'strtolower'); ?>">
									<input class="input birthday year" date-type="year" type="text" placeholder="<?php print $_language->text('year', 'strtolower'); ?>">
								</div>
							</div>
