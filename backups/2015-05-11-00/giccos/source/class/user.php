		...
		if ($id > 0 && $rows != null) {
			...
			if ($select != null) {
				...
				if ($query && mysqli_num_rows($query) > 0) {
					...
					$profileArr = $fetch;
					return array("return" => true, "data" => $profileArr);
				}else {
					return array("return" => false, "reason" => "");
				}
			}else {
		...
		if (is_array($user)) {
			...
			if (!preg_match($regexUsername, $user["username"])) {
				...
				if ($username_num > 0) {
					...
					$cover['large'] = "::default::user::cover::large";
					$cover['medium'] = "::default::user::cover::medium";
					$cover['small'] = "::default::user::cover::small";
					$avatar['large'] = "::default::user::avatar::large";
					$avatar['medium'] = "::default::user::avatar::medium";
					$avatar['small'] = "::default::user::avatar::small";
					...
					$activated = 0; // key: user::user_id::keyhash.
					$verified = 0;
					$dead = 0;
					...
					$sql = "INSERT INTO `users` (`id`, `token`, `secret`, `username`, `email`, `password`, `password.hash`, `phone`, `fullname`, `firstname`, `middlename`, `lastname`, `nickname`, `gender`, `interest`, `birthday`, `birthday.format`, `relationship`, `mate`, `family`, `language`, `timezone`, `introduction`, `slogan`, `avatar.large`, `avatar.medium`, `avatar.small`, `cover.large`, `cover.medium`, `cover.small`, `theme`, `link`, `register`, `private.tag`, `private.search`, `private.info.friends`, `private.info.birthday`, `private.info.country`, `private.info.live`, `private.info.email`, `private.info.phone`, `private.status.view`, `private.status.comment`, `private.status.share`, `private.photos.view`, `private.photos.comment`, `private.photos.share`, `private.music.view`, `private.music.comment`, `private.videos.share`, `private.videos.view`, `private.videos.comment`, `private.videos.share`, `country`, `live`, `units.temperature`, `units.speed`, `units.pressure`, `units.distance`, `videos.replay`, `music.replay`, `activated`, `verified`, `dead`) VALUES (null, '{$token}', '{$secret}', '{$username}', '{$email}', '{$password['hash']}', '{$password['base']}', '{$phone}', '{$name['full']}', '{$name['first']}', null, '{$name['last']}', null, '{$gender}', null, '{$birthday['stamp']}', '{$birthday['format']}', null, null, null, '{$language}', '{$timezone}', null, null, '{$avatar['large']}', '{$avatar['medium']}', '{$avatar['small']}', '{$cover['large']}', '{$cover['medium']}', '{$cover['small']}', '{$theme}', '{$link}', '{$register}', '{$private['tag']}', '{$private['search']}', '{$private['info']['friends']}', '{$private['info']['birthday']}', '{$private['info']['country']}', '{$private['info']['live']}', '{$private['info']['email']}', '{$private['info']['phone']}', '{$private['status']['view']}', '{$private['status']['comment']}', '{$private['status']['share']}', '{$private['photos']['view']}', '{$private['photos']['comment']}', '{$private['photos']['share']}', '{$private['music']['view']}', '{$private['music']['comment']}', '{$private['music']['share']}', '{$private['videos']['view']}', '{$private['videos']['comment']}', '{$private['videos']['share']}', null, null, '{$units['temperature']}', '{$units['speed']}', '{$units['pressure']}', '{$units['distance']}', '{$videos['replay']}', '{$music['replay']}', '{$activated}', '{$verified}', '{$dead}')";
