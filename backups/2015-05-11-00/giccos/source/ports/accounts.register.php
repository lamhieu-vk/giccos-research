			...
			<div id="gBox">
				...
				<div id="centerBox">
					<div id="headerBox">
						...
						<div class="lines desc"><span><?php print $_language->text('pages_accounts_register.desc', 'ucfirst'); ?></span></div>
					</div>
					<div id="registerBox" class="box">
						<div class="header"> <span><?php print $_language->text('register', 'ucfirst'); ?></span> </div>
						<div class="body">
							<div class="rows username odd">
							...
							<div class="lines check_terms">
								<label class="hide"><?php print $_language->text('check_terms', 'ucfirst'); ?></label>
								<div>
									<div class="input check_terms checkbox">
										<div class="dot"><div></div></div>
										<div class="text"><span><?php print $_language->text('checkbox_agree_terms', 'strtolower'); ?></span></div>
									</div>
								</div>
							</div>
							<div class="lines">
