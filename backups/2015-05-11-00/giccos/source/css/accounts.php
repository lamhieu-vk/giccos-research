...
html.accounts.login #gBox > #centerBox > #loginBox > .body > .lines input {
	...
	border-radius: 4px;
	color: #999;
	font: normal 400 12px/1.2em "Roboto";
...
html.accounts.register #gBox > #centerBox > #registerBox > .body > .rows:nth-child(1),
html.accounts.register #gBox > #centerBox > #registerBox > .body > .rows:nth-child(2) {
	padding-top: 10px;
}
...
html.accounts.getpassword #gBox > #centerBox > #getpasswordBox > .body > .lines:first-child {
	padding-top: 10px;
}
