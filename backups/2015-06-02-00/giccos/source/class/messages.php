...
Class messages {
	...
	function tab ($object) {
		...
		if ($action == "add" || $action == "create") {
			...
			$tabInfo['deleted'] = 0;
			$createTabReuqest = "INSERT INTO `messages_id` (`id`, `time`, `token`, `display`, `private`, `type`, `name`, `language`, `deleted`) VALUES (NULL, '{$tabInfo['time']}', '{$tabInfo['token']}', '{$tabInfo['display']}', '{$tabInfo['private']}', '{$tabInfo['type']}', '{$tabInfo['name']}', '{$tabInfo['language']}', '{$tabInfo['deleted']}');";
