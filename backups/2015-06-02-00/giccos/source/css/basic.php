...
.messagesTab[display] > .content .list > .rows.typing > .text > .context {
	width: 24px;
}
...
.messagesTab[display] > .content .list > .rows.left > .text > .context > .timetext {
	text-align: left;
}
.messagesTab[display] > .content .list > .rows.right > .text > .context > .timetext {
	text-align: left;
}
...
[tag] > i {
	cursor: pointer;
  	margin-left: 4px;
  	font: normal normal normal 10px/1em 'FontAwesome';
}
[tag] > i:before {
	content: '\f00d';
}