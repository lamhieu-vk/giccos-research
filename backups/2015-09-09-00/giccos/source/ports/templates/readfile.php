...
if (!$pageUpdated && $checkID) {
	if (!isset($_SESSION["cache"]['page'][hash('crc32', $_client->fullurl())]['called'])) {
		$_SESSION["cache"]['page'][hash('crc32', $_client->fullurl())]['called'] = 0;
	}
	$_SESSION["cache"]['page'][hash('crc32', $_client->fullurl())]['called']++;
