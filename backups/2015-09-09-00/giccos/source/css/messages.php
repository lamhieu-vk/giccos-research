...
html.messages.general #centerBox > #messagesData > .content {
	margin: auto;
	padding: 2px 0;
	width: 98%;
}
html.messages.general #centerBox > #messagesData > .content .lines {
	cursor: pointer;
	display: inline-block;
	vertical-align: top;
	margin: 4px 2px;
...
html.messages.general #centerBox > #messagesData > .content .lines > .header > .name {
	padding: 2px 6px 3px;
  	border-bottom: 1px solid #DDD;
}
html.messages.general #centerBox > #messagesData > .content .lines > .header > .name i {
	color: #999;
	font: normal normal normal 13px/1 FontAwesome;
}
html.messages.general #centerBox > #messagesData > .content .lines[type='private'] > .header > .name i:before {
	content: "\f007";
}
html.messages.general #centerBox > #messagesData > .content .lines[type='groups'] > .header > .name i:before {
	content: "\f0c0";
}
html.messages.general #centerBox > #messagesData > .content .lines > .header > .name span {
	color: #666;
	line-height: 1.6em;
	font-family: Roboto;
	font-size: 12px;
...
html.messages.general #centerBox > #messagesData > .content .lines:hover > .header > .name span {
	font-style: italic;
}
html.messages.general #centerBox > #messagesData > .content .lines > .body {
	
}
html.messages.general #centerBox > #messagesData > .content .lines > .body > .box {
	display: inline-block;
	vertical-align: top;
	height: 40px;
}
html.messages.general #centerBox > #messagesData > .content .lines > .body > .box.left {
	width: 40px;
	border-right: 1px solid #DDD;
}
html.messages.general #centerBox > #messagesData > .content .lines > .body > .box.left > .thumbnail {
	overflow: hidden;
	margin: 3px;
	height: 34px;
	width: 34px;
}
html.messages.general #centerBox > #messagesData > .content .lines > .body > .box.left > .thumbnail .img {
...
html.messages.general #centerBox > #messagesData > .content .lines > .body > .box.left > .thumbnail.on .img {
	height: 100%;
	width: 100%;
}
html.messages.general #centerBox > #messagesData > .content .lines > .body > .box.left > .thumbnail.tw .img {
	width: 50%;
  	height: 100%;
}
html.messages.general #centerBox > #messagesData > .content .lines > .body > .box.left > .thumbnail.th .img:nth-child(1) {
	width: 50%;
	height: 100%;
}
html.messages.general #centerBox > #messagesData > .content .lines > .body > .box.left > .thumbnail.th .img:nth-child(2),
html.messages.general #centerBox > #messagesData > .content .lines > .body > .box.left > .thumbnail.th .img:nth-child(3) {
	width: 50%;
	height: 50%;
}
html.messages.general #centerBox > #messagesData > .content .lines > .body > .box.left > .thumbnail.fo .img {
	width: 50%;
	height: 50%;
}
html.messages.general #centerBox > #messagesData > .content .lines > .body > .box.right {
	margin-left: -2px;
	width: 170px;
}
html.messages.general #centerBox > #messagesData > .content .lines > .body > .box.right > .text {
	overflow: hidden;
...
html.messages.general #centerBox > #messagesData > .content .lines > .body > .box.right > .text span {
	font-size: 12px;
	color: #777;
}
html.messages.general #centerBox > #messagesData > .content .lines > .body > .box.right > .text [emotions-key] {
	display: inline-block;
  	vertical-align: top;
  	height: 14px;
	width: 14px;
...
html.messages.general #centerBox > #messagesData > .content .lines > .body > .box.right > .time {
	display: inherit;
	margin: 2px;
	text-indent: 2px;
}
html.messages.general #centerBox > #messagesData > .content .lines > .body > .box.right > .time i {
	color: #999;
	font: normal normal normal 11px/1em FontAwesome;
}
html.messages.general #centerBox > #messagesData > .content .lines > .body > .box.right > .time i:before {
	content: "\f017";
}
html.messages.general #centerBox > #messagesData > .content .lines > .body > .box.right > .time span {
	font-size: 11px;
	color: #999;
}
html.messages.general #centerBox > #messagesData > .content .lines > .footer {
	border-top: 1px solid #DDD;
}
html.messages.general #centerBox > #messagesData > .content .lines > .footer > .members {
	
}
html.messages.general #centerBox > #messagesData > .content .lines > .footer > .members > i {
	color: #999;
	font: normal normal normal 11px/1em FontAwesome;
}
html.messages.general #centerBox > #messagesData > .content .lines > .footer > .members > i:before {
	content: "\f007";
}
html.messages.general #centerBox > #nullBox {
	height: 120px;
}
