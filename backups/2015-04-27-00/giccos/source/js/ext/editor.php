...
function PhotosTagPopup (object) {
	...
	tagsBox.children(".wrapper").css({'margin-top': imageBox.children(".img").css('margin-top'), 'height': imageBox.find(".img").height(), 'width': imageBox.find(".img").width()});
