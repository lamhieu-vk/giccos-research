			...
			<div id="gBox">
				...
				<div id="centerBox">
					<div id="headerBox">
						...
						<div class="lines desc"><span><?php print $_language->text('pages_accounts_active.desc', 'ucfirst'); ?></span></div>
					</div>
					<div id="activeBox" class="box">
						<div class="header"> <span><?php print $_language->text('active_accounts', 'ucfirst'); ?></span> </div>
						<div class="body">
							<div class="lines code">
								<label><?php print $_language->text('code', 'ucfirst'); ?></label>
								<div><input class="input code" type="text" placeholder="<?php print $_language->text('type_code', 'strtolower'); ?>"></div>
							</div>
					...
					<div id="footerBox">
						...
						<div class="li active selected _tt-we s" title="<?php print $_language->text('active_accounts', 'strtolower'); ?>">
							<a href="<?php print $_tool->links('accounts/getpassword#'); ?>"><?php print $_language->text('active', 'ucfirst'); ?></a>
						</div>
					</div>
				</div>
			</div>
