				...
				while ($getProfileFetch = mysqli_fetch_assoc($getProfileQuery)) {
					...
					if (isset($getProfileFetch['avatar.large'])) {
						if (preg_match("/^(\:\:default)/", $getProfileFetch['avatar.large'])) {
							...
							$getProfileFetch['avatar.large'] = $_tool->hash('decode', $getProfileFetch['avatar.large'], $id."_".$getProfileFetch['secret']);
					...
					if (isset($getProfileFetch['avatar.medium'])) {
						if (preg_match("/^(\:\:default)/", $getProfileFetch['avatar.medium'])) {
							...
							$getProfileFetch['avatar.medium'] = $_tool->hash('decode', $getProfileFetch['avatar.medium'], $id."_".$getProfileFetch['secret']);
					...
					if (isset($getProfileFetch['avatar.small'])) {
						if (preg_match("/^(\:\:default)/", $getProfileFetch['avatar.small'])) {
							...
							$getProfileFetch['avatar.small'] = $_tool->hash('decode', $getProfileFetch['avatar.small'], $id."_".$getProfileFetch['secret']);
					...
					if (isset($getProfileFetch['cover.large'])) {
						if (preg_match("/^(\:\:default)/", $getProfileFetch['cover.large'])) {
							...
							$getProfileFetch['cover.large'] = $_tool->hash('decode', $getProfileFetch['cover.large'], $id."_".$getProfileFetch['secret']);
					...
					if (isset($getProfileFetch['cover.medium'])) {
						if (preg_match("/^(\:\:default)/", $getProfileFetch['cover.medium'])) {
							...
							$getProfileFetch['cover.medium'] = $_tool->hash('decode', $getProfileFetch['cover.medium'], $id."_".$getProfileFetch['secret']);
					...
					if (isset($getProfileFetch['cover.small'])) {
						if (preg_match("/^(\:\:default)/", $getProfileFetch['cover.small'])) {
							...
							$getProfileFetch['cover.small'] = $_tool->hash('decode', $getProfileFetch['cover.small'], $id."_".$getProfileFetch['secret']);
