...
var feed_status_push = function (options, status) {
	...
	var code = " <div class='status inFeeds boxGrid _h' status='"+c_['status_info']+"' status-id='"+status['info']['id']+"'> <div class='header'> <div class='cover'> <div class='wrap'> </div> <div class='img' style='background-image: url("+status['author']['cover']+")'> <img class='img' src='"+status['author']['cover']+"'> </div> </div> <div class='avatar'> <a href='"+status['author']['link']+"'> <img class='img' src='"+status['author']['avatar']+"'> </a> </div> <div class='user'> "+c_['status_author_verified']+" <div class='name'> <a href='"+status['author']['link']+"'> <span>"+status['author']['name']+"</span> </a> </div> <div class='tag'> <a href='"+status['author']['link']+"'> <span>"+status['author']['tag']+"</span> </a> </div> </div> <div class='info'>"+c_['status_date']+""+c_['status_private']+""+c_['status_edit']+""+c_['status_places']+""+c_['status_mood']+"</div> "+c_['status_menu']+" </div> <div class='body'>"+c_['status_content_text']+""+c_['status_content_media']+""+c_['status_content_usertag']+"</div> <div class='footer'> <div class='info'> <div class='action'>"+c_['status_action_favorite']+""+c_['status_action_share']+""+c_['status_action_invite']+"</div> <div class='statistic'> <div class='favorite'> <i></i> <span status-statistic-favorite>"+status['statistic']['favorite']+"</span> </div> <div class='share'> <i></i> <span status-statistic-share>"+status['statistic']['share']+"</span> </div> <div class='invite'> <i></i> <span status-statistic-invite>"+status['statistic']['invite']+"</span> </div> </div> </div> <div class='comment'> <div class='type "+c_['private_comment_class']+"' status-comment-type>"+c_['private_comment']+"</div>"+c_['status_comment']+"<div class='content' status-comment-content>"+c_['status_comment_null']+""+c_['status_comment_rows']+"</div> </div> </div> </div> ";
	var feed = $(".thisFeeds[feed]"),
