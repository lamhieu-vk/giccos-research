...
html.messages.general #gBox .boxGrid {
	margin: 10px auto;
}
html.messages.general #gBox .boxGrid > .title {
	margin: 4px 0;
	padding: 2px 6px 5px;
  	border-bottom: 1px solid #E5E5E5;
}
html.messages.general #gBox .boxGrid > .title span {
	color: #666;
	font: normal normal 300 12px/1.6em "Roboto";
    text-transform: uppercase;
}
html.messages.general #gBox #messagesData > .title {
	
}
html.messages.general #gBox #messagesData > .title > .messagesCreateButton {
	float: right;
	display: inline-block;
	vertical-align: top;
	margin-top: 1px;
}
html.messages.general #gBox #messagesData > .title > .messagesCreateButton i {
	cursor: pointer;
	color: #AAA;
  	font: normal normal normal 14px/1em FontAwesome;
  	transition: color .5s ease;
}
html.messages.general #gBox #messagesData > .title > .messagesCreateButton i:hover {
	color: #888;
}
html.messages.general #gBox #messagesData > .title > .messagesCreateButton i:before {
	content: "\f067";
}
html.messages.general #gBox #messagesData > .content .null.notify {
	padding: 6px 0 12px;
	text-align: center;
}
html.messages.general #gBox #messagesData > .content .null.notify .icon {
	color: #D8D8D8;
  	font: normal normal normal 40px/1em FontAwesome;
}
html.messages.general #gBox #messagesData > .content .null.notify .icon:before {
	content: "\f086";
}
html.messages.general #gBox #messagesData > .content .null.notify span {
	color: #CCC;
	font-size: 12px;
	line-height: 1.4em;
	text-transform: lowercase;
}
html.messages.general #gBox #messagesData > .content {
	margin: auto;
	padding: 2px 0;
	width: 98%;
}
html.messages.general #gBox #messagesData > .content .lines {
	cursor: pointer;
	display: inline-block;
	vertical-align: top;
	margin: 4px 2px;
...
html.messages.general #gBox #messagesData > .content .lines > .header > .name {
    overflow: hidden;
...
html.messages.general #gBox #messagesData > .content .lines > .header > .name i {
	display: inline-block;
    vertical-align: top;
    margin-top: 3px;
	color: #999;
...
html.messages.general #gBox #messagesData > .content .lines[type='private'] > .header > .name i:before {
	content: "\f007";
}
html.messages.general #gBox #messagesData > .content .lines[type='groups'] > .header > .name i:before {
	content: "\f0c0";
}
html.messages.general #gBox #messagesData > .content .lines > .header > .name span {
	color: #999;
	line-height: 1.6em;
	font-size: 12px;
}
html.messages.general #gBox #messagesData > .content .lines:hover > .header > .name span {
	font-style: italic;
}
html.messages.general #gBox #messagesData > .content .lines > .body {
	
}
html.messages.general #gBox #messagesData > .content .lines > .body > .box {
	display: inline-block;
	vertical-align: top;
	height: 40px;
}
html.messages.general #gBox #messagesData > .content .lines > .body > .box.left {
	width: 40px;
	border-right: 1px solid #DDD;
}
html.messages.general #gBox #messagesData > .content .lines > .body > .box.left > .thumbnail {
	overflow: hidden;
	margin: 3px;
	height: 34px;
	width: 34px;
...
html.messages.general #gBox #messagesData > .content .lines > .body > .box.left > .thumbnail .img {
...
html.messages.general #gBox #messagesData > .content .lines > .body > .box.left > .thumbnail.on .img {
	height: 100%;
	width: 100%;
}
html.messages.general #gBox #messagesData > .content .lines > .body > .box.left > .thumbnail.tw .img {
	width: 50%;
  	height: 100%;
}
html.messages.general #gBox #messagesData > .content .lines > .body > .box.left > .thumbnail.th .img:nth-child(1) {
	width: 50%;
	height: 100%;
}
html.messages.general #gBox #messagesData > .content .lines > .body > .box.left > .thumbnail.th .img:nth-child(2),
html.messages.general #gBox #messagesData > .content .lines > .body > .box.left > .thumbnail.th .img:nth-child(3) {
	width: 50%;
	height: 50%;
}
html.messages.general #gBox #messagesData > .content .lines > .body > .box.left > .thumbnail.fo .img {
	width: 50%;
	height: 50%;
}
html.messages.general #gBox #messagesData > .content .lines > .body > .box.right {
	margin-left: -2px;
	width: 170px;
}
html.messages.general #gBox #messagesData > .content .lines > .body > .box.right > .text {
	overflow: hidden;
	text-overflow: ellipsis;
	white-space: nowrap;
	margin: 4px 2px -2px;
...
html.messages.general #gBox #messagesData > .content .lines > .body > .box.right > .text span {
	font-size: 12px;
	color: #999;
}
html.messages.general #gBox #messagesData > .content .lines > .body > .box.right > .text [emotions-key] {
	display: inline-block;
  	vertical-align: top;
  	height: 14px;
	width: 14px;
...
html.messages.general #gBox #messagesData > .content .lines > .body > .box.right > .time {
	display: inherit;
	margin: 2px;
	text-indent: 2px;
}
html.messages.general #gBox #messagesData > .content .lines > .body > .box.right > .time i {
	color: #999;
	font: normal normal normal 11px/1em FontAwesome;
}
html.messages.general #gBox #messagesData > .content .lines > .body > .box.right > .time i:before {
	content: "\f017";
}
html.messages.general #gBox #messagesData > .content .lines > .body > .box.right > .time span {
	font-size: 11px;
	color: #999;
}
html.messages.general #gBox #messagesData > .content .lines > .footer {
	border-top: 1px solid #DDD;
}
html.messages.general #gBox #messagesData > .content .lines > .footer > .members {
	
}
html.messages.general #gBox #messagesData > .content .lines > .footer > .members > i {
	color: #999;
	font: normal normal normal 11px/1em FontAwesome;
}
html.messages.general #gBox #messagesData > .content .lines > .footer > .members > i:before {
	content: "\f007";
}
html.messages.general #gBox #nullBox {
	height: 120px;
}
