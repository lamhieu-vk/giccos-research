function resizeTemplateBoxFalse (){
	function navCover () {
...
function actionRequestFormRegister () {
...
function pushSelectFormRegister () {
	var select = $(".boxForm#gRegister > .content > .lines select");
...
$(document).ready(function(){
	resizeTemplateBoxFalse();
	actionRequestFormRegister();
	pushSelectFormRegister();
});