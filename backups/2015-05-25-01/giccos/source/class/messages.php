...
Class messages {
	...
	function tab ($object) {
		...
		if ($action == "add" || $action == "create") {
			...
			$getTabRequest = "SELECT * FROM `messages_id` WHERE `{$tabLabel}` = '{$tabValue}' {$tabLimit}";
	...
	function members ($object) {
		...
		if ($action == "add") {
			...
			$getMembersRequest = "SELECT * FROM `messages_members` WHERE `{$membersLabel}` = '{$membersValue}' {$getMembersRequestPush} {$membersLimit}";
