...
//.print_r($_SESSION["client"]['language']['list']);die;
		...
		<div id="gPage">
			<div id="gMain">
						...
						<div id="infoPage" class="boxGrid">
							...
							<div class="rate box">
								...
								<div class="content">
									<div class="rows total">
										...
										<div class="value"><span><?php if (isset($siteInfoArr['rate']['total'])) { print $siteInfoArr['rate']['total']; }else { print $_language->text('undefined', 'strtolower'); } ?> <?php print $_language->text('times_recorded', 'strtolower'); ?></span></div>
									</div>
								...
								<div class="content">
									<div class="rows table">
										<div class="value views"> 
											...
											_g['session'].add("sites_info_stats_views_dataset", datasetOptions);
											</script>
										</div>
										<div class="value mention"> 
											...
											_g['session'].add("sites_info_stats_mention_dataset", datasetOptions);
											</script>
										</div>
										<div class="value">
											<div class="statsTip"> 
							...
							<div class="info box">
								...
								<div class="content">
									...
									<?php if (isset($siteInfoArr['type']) && is_string($siteInfoArr['type']) && $siteInfoArr['type'] != null) { ?>
									<div class="rows type">
										<div class="label"><span><?php print $_language->text('type', 'ucfirst'); ?></span></div>
										<div class="value">
										<?php
										$siteInfoTypesArr = explode(" ", $siteInfoArr['type']);
										$siteInfoTypesShowed = array();
										foreach ($siteInfoTypesArr as $labelTypeThis => $valueTypeThis) {
											if (in_array($valueTypeThis, $siteInfoTypesShowed)) {
												continue;
											}else {
												$siteInfoTypesShowed[] = $valueTypeThis;
											}
											print " <a href='".$_tool->links('sites/type/'.$valueTypeThis)."'>".$valueTypeThis."</a> ";
										}
										if (count($siteInfoTypesShowed) == 0) {
											print "-";
										}
										?>
										</div>
									...
									<?php } ?>
									<?php if (isset($siteInfoArr['language']) && is_string($siteInfoArr['language']) && $siteInfoArr['language'] != null) { ?>
									<div class="rows language">
										<div class="label"><span><?php print $_language->text('language', 'ucfirst'); ?></span></div>
										<div class="value">
											<span>
											<?php 
											if (isset($siteInfoArr['language'])) { 
												foreach ($g_client['language']['list'] as $labelLanguageList => $valueLanguageThis) {
													if (isset($valueLanguageThis['code']) && $valueLanguageThis['code'] == strtolower($siteInfoArr['language'])) {
														$valueLanguage = $valueLanguageThis['name'];
														break;
													}
												}
												if (isset($valueLanguage) && $valueLanguage != null) {
													print $valueLanguage; 
												}else {
													print $siteInfoArr['language']; 
												}
											}else { 
												print "-"; 
											} 
									...
									<?php } ?>
									<?php if (isset($siteInfoArr['country']) && is_string($siteInfoArr['country']) && $siteInfoArr['country'] != null) { ?>
									<div class="rows local">
										<div class="label"><span><?php print $_language->text('country', 'ucfirst'); ?></span></div>
										<div class="value">
											<span>
											<?php 
											if (isset($siteInfoArr['country'])) { 
												foreach ($g_client['language']['list'] as $labelCountryList => $valueCountryThis) {
													if (isset($valueCountryThis['country'], $valueCountryThis['country']['code']) && $valueCountryThis['country']['code'] == strtolower($siteInfoArr['country'])) {
														$valueCountry = $valueCountryThis['country']['name'];
														break;
													}
												}
												if (isset($valueCountry) && $valueCountry != null) {
													print $valueCountry; 
												}else {
													print $siteInfoArr['country']; 
												}
											}else { 
												print "-"; 
											} 
									...
									<?php } ?>
									<?php if (isset($siteInfoArr['tags']) && is_string($siteInfoArr['tags']) && $siteInfoArr['tags'] != null) { ?>
									<div class="rows tags">
										<div class="label"><span><?php print $_language->text('tags', 'ucfirst'); ?></span></div>
										<div class="value">
										<?php
										$siteInfoTagsArr = explode(" ", $siteInfoArr['tags']);
										$siteInfoTagsShowed = array();
										foreach ($siteInfoTagsArr as $labelTagThis => $valueTagThis) {
											if (in_array($valueTagThis, $siteInfoTagsShowed)) {
												continue;
											}else {
												$siteInfoTagsShowed[] = $valueTagThis;
											}
											print " <a href='".$_tool->links('sites/tags/'.$valueTagThis)."'>".$valueTagThis."</a> ";
										}
										if (count($siteInfoTagsShowed) == 0) {
											print "-";
										}
										?>
										</div>
									...
									<div class="rows updated">
										<div class="label"><span><?php print $_language->text('last_updated', 'ucfirst'); ?></span></div>
				...
				<div id="gInclude">
					...
					<script src="<?php print $_tool->links("source/js/sites.info.js"); ?>" type="text/javascript"></script>
				</div>
			</div>
