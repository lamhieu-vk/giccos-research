...
.gplayer-skin.v-simple .gplayer-control-bar .gplayer-slider .gplayer-pointtag-dot {
  ...
  border: none;
  box-shadow: 0 0 9px rgba(51, 51, 51, 0.51);
...
.gplayer-skin.v-simple .gplayer-control-bar .gplayer-quality-button .gplayer-control-menu span {
  font: normal normal 400 11px/1.4em "Helvetica Neue", "HelveticaNeue", Helvetica, Arial, sans-serif;
}
...
.gplayer-skin.v-simple .gplayer-control-bar .gplayer-progress-tips {
  display: none;
  position: absolute;
  visibility: visible;
  display: block;
...
.gplayer-skin.v-simple .gplayer-control-bar .gplayer-progress-tips > .arrow {
  display: none;
  position: absolute;
  bottom: 0;
  left: 50%;
...
.gplayer-skin.v-simple .gplayer-control-bar .gplayer-progress-tips > .arrow:before {
  content: '';
  position: absolute;
  margin-top: 0;
  margin-left: -2px;
...
.gplayer-skin.v-simple .gplayer-control-bar .gplayer-progress-tips > .inner {
...
.gplayer-skin.v-simple .gplayer-control-bar .gplayer-preview-tips {
  position: absolute;
  visibility: visible;
  display: none;
  opacity: 1;
...
.gplayer-skin.v-simple .gplayer-control-bar .gplayer-preview-tips > .inner {
  position: relative;
  overflow: hidden;
  background: rgba(34, 34, 34, 0.8);
  border: none;
...
.gplayer-skin.v-simple .gplayer-control-bar .gplayer-preview-tips > .inner > .thumbnail {
  position: relative;
  overflow: hidden;
...
.gplayer-skin.v-simple .gplayer-control-bar .gplayer-preview-tips > .inner > .thumbnail > img {
  position: absolute; 
  top: 0;
  left: 0;
  width: 128px;
...
.gplayer-skin.v-simple .gplayer-control-bar .gplayer-preview-tips > .inner > .text {
  position: absolute;
  top: 5px;
  left: 5px;
  padding: 2px 6px 2px;
...
.gplayer-skin.v-simple .gplayer-control-bar .gplayer-preview-tips > .inner > .text span {
  color: #FFF;
  font: 400 11px/1em "Helvetica Neue", "HelveticaNeue", Helvetica, Arial, sans-serif;
  text-shadow: 0 0 3px #333;
}
...
.gplayer-skin.v-simple.gplayer-has-started .gplayer-pointtag {
  opacity: 0.85;
}
...
.gplayer-skin.v-simple .gplayer-pointtag > .list > .li[focus='true'] > .content {
  border-left: 2px solid rgba(255, 255, 255, 0.8);
}
.gplayer-skin.v-simple .gplayer-pointtag > .list > .li:hover > .content {
  display: none;
}
