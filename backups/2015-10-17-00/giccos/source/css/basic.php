...
.boxGrid {
	...
	box-shadow: 0 0 10px rgba(175, 175, 175, 0.25);
	border-radius: 4px;
}
.navProcess-buffering,
.boxLoading.buffering {
...
@-webkit-keyframes sk-cubemove {
  ...
  75% { -webkit-transform: translateX(0%) translateY(100%) rotate(-270deg) scale(0.5) }
...
#popupAlert .box > .title i[close]:hover {
	color: #666;
}
...
.messagesTab[display] > .thumbnail > .box > .wrap {
	z-index: 2;
    position: absolute;
    top: 0;
    left: 0;
...
.messagesTab[display] > .thumbnail > .box > .border {
	position: relative;
    display: inline-block;
    vertical-align: top;
	width: 100%;
...
.messagesTab[display] > .thumbnail > .box > .border > .img {
...
.messagesTab[display] > .thumbnail > .box.on > .border .img {
	height: 100%;
	width: 100%;
}
.messagesTab[display] > .thumbnail > .box.tw > .border .img {
	width: 50%;
  	height: 100%;
}
.messagesTab[display] > .thumbnail > .box.th > .border .img:nth-child(1) {
	width: 50%;
	height: 100%;
}
.messagesTab[display] > .thumbnail > .box.th > .border .img:nth-child(2),
.messagesTab[display] > .thumbnail > .box.th > .border .img:nth-child(3) {
	width: 50%;
	height: 50%;
}
.messagesTab[display] > .thumbnail > .box.fo > .border .img {
	width: 50%;
	height: 50%;
}
.messagesTab[display] > .thumbnail > .options {
	z-index: 2;
    position: absolute;
    top: 0;
    left: 35px;
...
.messagesTab[display] > .thumbnail > .options > .close {
	display: block;
	margin: 2px 0 0 5px;
}
.messagesTab[display] > .thumbnail > .options > .close .icon {
	color: #999;
	font: normal normal 300 12px/1em FontAwesome;
	transition: color .5s ease;
}
.messagesTab[display] > .thumbnail > .options > .close .icon:hover {
	color: #666;
}
.messagesTab[display] > .thumbnail > .options > .close > .icon {
	
}
.messagesTab[display] > .thumbnail > .options > .close > .icon:before {
	content: "\f00d";
}
...
.messagesTab[display] > .title > .options .icon {
	color: #AAA;
	font: normal normal 300 13px/2em FontAwesome;
	transition: color .5s ease;
}
.messagesTab[display] > .title > .options .icon:hover {
	color: #888;
}
...
.messagesTab[display] > .title > .options > .settings > .tab > .rows {
	...
	margin: 0;
	padding: 3px 6px;
	-webki-transition: background-color .5s ease;
...
#popupCreateMessages .box > .title i[close]:hover {
	color: #666;
}
#popupCreateMessages .box > .title i[close]:before {
	content: "\f00d";
}
...
#actionSettingMessages > .box > .title > i {
	color: #666;
	transition: color .5s ease;
}
#actionSettingMessages > .box > .title span {
...
#actionSettingMessages > .box > .title i[close]:hover {
	color: #666;
}
#actionSettingMessages > .box > .title i[close]:before {
	content: "\f00d";
}
...
#userInfoEditor > .boxContent > .header i:hover,
#userInfoVerify > .boxContent > .header i:hover {
	color: #666;
}
...
#userInfoEditor > .boxContent > .body .main[type='contact'] > .lines.important input,
...
#userInfoEditor > .boxContent > .body .main[type='contact'] > .lines.phone input,
#userInfoEditor > .boxContent > .body .main[type='contact'] > .lines.email input {
	/*width: 87%;*/
	width: 78%;
}
...
#userInfoEditor > .boxContent > .body .main > .lines .private .choosePrivate .selected > .rows > i {
	margin: 0;
}
