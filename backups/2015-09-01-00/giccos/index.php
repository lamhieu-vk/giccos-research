...
die;
require_once ("source/class/mailer.autoloader.php");
$mail = new PHPMailer;
$mail->SMTPDebug = 3;                               // Enable verbose debug output
$mail->isSMTP();                                      // Set mailer to use SMTP
$mail->Host = "smtp.gmail.com";  // Specify main and backup SMTP servers
$mail->SMTPAuth = true;                               // Enable SMTP authentication
$mail->Username = "lamhieu.vk@gmail.com";                 // SMTP username
$mail->Password = "password";                           // SMTP password
$mail->SMTPSecure = "tls";                            // Enable TLS encryption, `ssl` also accepted
$mail->Port = 587;                                    // TCP port to connect to
$mail->From = "mailer@giccos.com";
$mail->FromName = "Giccos Mailer";
$mail->addAddress("giccos.inc@gmail.com", "Joe User");     // Add a recipient
$mail->addReplyTo("support@giccos.com", "Giccos Support");
        ...
        <td>
            <table border='0' cellspacing='0' cellpadding='0' style='padding: 10px;width:500px;background: #FFF;border: none;'>
                <tbody>
                    <tr>
                        <td>
                            <table bgcolor='#4184F3' width='100%' border='0' cellspacing='0' cellpadding='0' style='width:500px;background-color: #666;border:none;'>
                                <tbody>
                                    <tr>
                                        <td colspan='3' style='height: 70px;border-bottom: 2px solid #FFF;'>
	                                        <div style='display: inline-block;vertical-align: top;text-indent: 30px;'>
	                                        	<a style='cursor: pointer;font-family: Roboto-Regular,Helvetica,Arial,sans-serif;font-size: 32px; color: #FFF;line-height: 1.2;font-weight:bold;'>Giccos Inc</a>
	                                        </div>
	                                        <div style='display: inline-block;vertical-align: top;margin-top: 2px;width: 270px;text-align: right;'>
	                                        	<a style='cursor: pointer;font-family: Roboto-Regular,Helvetica,Arial,sans-serif;font-size: 18px; color: #FFF;line-height: 1.2;font-weight:bold;'>Mailer</a><br>
	                                        	<a style='font-family: Roboto-Regular,Helvetica,Arial,sans-serif;font-size: 12px; color: #CCC;line-height: 1.2;font-weight:normal;'>#dd24cfsa</a>
	                                        </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td width='30px'></td>
                                        <td style='font-family:Roboto-Regular,Helvetica,Arial,sans-serif;font-size:16px;color:#ffffff;line-height:1.25'>verify user account</td>
                                        <td width='30px'></td>
                                    </tr>
                                    <tr><td height='10px' colspan='3'></td></tr>
                                </tbody>
                    ...
                    <tr>
                        <td>
                            <table bgcolor='#FAFAFA' width='100%' border='0' cellspacing='0' cellpadding='0' style='width:500px;border: none;'>
                                    ...
                                    <tr>
                                        <td>
                                            <table style='min-width:300px' border='0' cellspacing='0' cellpadding='0'>
                                                <tbody>
                                                   	<div style='margin-top: 5px;'><span>Hi, Lam Hieu.</span></div>
                                                   	<div style='margin-top: 5px;'>
	                                                   	<span>Someone used this email address to register your Giccos account.</span><br>
	                                                   	<span>Created at 18:35, 09/01/2015 (+07:00).</span>
                                                   	</div>
                                                   	<div style='margin-top: 5px;'>
                                                   		<span>If this is your account <a href='#' style='color: #555;text-decoration: none;'>active here</a>. And if you don't register account at Giccos, <a href='#' style='color: #555;text-decoration: none;'>report here</a></span></tr>
                                                   	</div>
                                                   	<div style='margin: 15px auto;width: 300px;'>
                                                   		<div style='margin: 15px auto;'>
                                                   			<div style='display: inline-block;vertical-align: top;'>
                                                   				<div style='height: 40px;width: 40px;background-color: #999;background-size: cover;background-position: 50% 50%;border: none;border-radius: 360px;'></div>
                                                   			</div>
                                                   			<div style='display: inline-block;vertical-align: top;margin: 3px 0 0 3px;'>
                                                   				<div><span style='line-height: 1.4;font-size: 14px; font-weight: bold;'>Lam Hieu</span></div>
                                                   				<div><span style='line-height: 1.4;font-size: 12px; font-weight: normal;'>lamhieu</span></div>
                                                   			</div>
                                                   		</div>
                                                   		<div style='margin: 15px auto;'>
                                                   			<div style='display: inline-block;vertical-align: top;'>
                                                   			...
                                                   			<div style='display: inline-block;vertical-align: top;margin: 3px 0 0 3px;'>
                                                   				<div><span style='line-height: 1.4;font-size: 14px; font-weight: bold;'>Window 10</span></div>
                                                   				<div><span style='line-height: 1.4;font-size: 12px; font-weight: normal;'>Chrome</span></div>
                                                   			</div>
                                                   		</div>
                                                   		<div style='margin: 15px auto;'>
                                                   			<div style='display: inline-block;vertical-align: top;'>
                                                   			...
                                                   			<div style='display: inline-block;vertical-align: top;margin: 3px 0 0 3px;'>
                                                   				<div><span style='line-height: 1.4;font-size: 14px; font-weight: bold;'>Brisbane, Australia</span></div>
                                                   				<div><span style='line-height: 1.4;font-size: 12px; font-weight: normal;'>-27.467939, 153.028091</span></div>
                                                   			</div>
                                                   		</div>
                                                   	</div>
...
die;
/*
$xx = $_ip->info(array("action" => "check", "ip" => $_client->ip()));
print_r($xx);
die;
*/
# Gzip.
...
if (isset($g_client['token']['source']['url']) && (in_array($_uri[0], $_uri_0, true) || $_uri[0] == $g_client['token']['source']['url'])) {
	...
	if (isset($_uri[0], $g_client['token']['source']['url']) && is_string($_uri[0]) && $_uri[0] == $g_client['token']['source']['url']) {
		if (isset($_uri[1], $g_client['token']['source']['js']) && is_string($_uri[1]) && $_uri[1] == $g_client['token']['source']['js']) {
			...
			if (isset($_SERVER['HTTP_REFERER'], $_SERVER['HTTP_HOST']) && $_tool->valueCheck("referer", $_SERVER['HTTP_REFERER']) && $_SERVER['HTTP_HOST'] == $_tool->links("::host")){
				...
				if (file_exists($scripts_file)) {
					$readFile = array("type" => "include", "path" => $scripts_file, "mime" => $_parameter->get('contentType_js.utf8'), "expire" => $_parameter->get('http_cache_expire_static'));
			...
			if (isset($_SERVER['HTTP_REFERER'], $_SERVER['HTTP_HOST']) && $_tool->valueCheck("referer", $_SERVER['HTTP_REFERER']) && $_SERVER['HTTP_HOST'] == $_tool->links("::host")){
				if (preg_match("/(\.css)$/", $css_file)) {
					...
					if (file_exists($css_file)) {
						$readFile = array("type" => "include", "path" => $css_file, "mime" => $_parameter->get('contentType_css.utf8'), "expire" => $_parameter->get('http_cache_expire_static'));
						die(require_once ("source/ports/templates/readfile.php"));
					}else {
						die(header("HTTP/1.1 503 Service Unavailable"));
					}
					...
					if (file_exists($css_file)) {
						$readFile = array("type" => "include", "path" => $css_file, "mime" => 'image/'.$ext_format, "expire" => $_parameter->get('http_cache_expire_static'));
						die(require_once ("source/ports/templates/readfile.php"));
					}else {
						die(header("HTTP/1.1 503 Service Unavailable"));
					}
			...
			if (isset($_SERVER['HTTP_REFERER'], $_SERVER['HTTP_HOST']) && $_tool->valueCheck("referer", $_SERVER['HTTP_REFERER']) && $_SERVER['HTTP_HOST'] == $_tool->links("::host")) {
				...
				if (file_exists($ajax_file)) {
					$readFile = array("type" => "include", "path" => $ajax_file, "mime" => $_parameter->get('contentType_json.utf8'), "expire" => $_parameter->get('http_cache_expire_static'));
					die(require_once ("source/ports/templates/readfile.php"));
				}else {
					die(header("HTTP/1.1 503 Service Unavailable"));
				}
			...
			if (isset($_SERVER['HTTP_REFERER'], $_SERVER['HTTP_HOST']) && $_tool->valueCheck("referer", $_SERVER['HTTP_REFERER']) && $_SERVER['HTTP_HOST'] == $_tool->links("::host")){
				...
				if (file_exists($xml_file)) {
					$readFile = array("type" => "include", "path" => $xml_file, "mime" => $_parameter->get('contentType_xml.utf8'), "expire" => $_parameter->get('http_cache_expire_static'));
					die(require_once ("source/ports/templates/readfile.php"));
				}else {
					die(header("HTTP/1.1 503 Service Unavailable"));
				}
			...
			if (isset($_SERVER['HTTP_REFERER'], $_SERVER['HTTP_HOST']) && $_tool->valueCheck("referer", $_SERVER['HTTP_REFERER']) && $_SERVER['HTTP_HOST'] == $_tool->links("::host")){
				...
				if (file_exists($font_file)) {
					...
					$readFile = array("type" => "other", "path" => $font_file, "mime" => $file_mine.'; charset: utf-8', "expire" => $_parameter->get('http_cache_expire_static'));
					die(require_once ("source/ports/templates/readfile.php"));
				}else {
					die(header("HTTP/1.1 503 Service Unavailable"));
				}
			...
			if (isset($_SERVER['HTTP_REFERER'], $_SERVER['HTTP_HOST']) && $_tool->valueCheck("referer", $_SERVER['HTTP_REFERER']) && $_SERVER['HTTP_HOST'] == $_tool->links("::host")){
				...
				if ($fileNum > 0) {
					...
					$readFile = array("type" => "other", "path" => $fileFetch['source'], "mime" => $fileFetch['mime'], "expire" => $_parameter->get('http_cache_expire_static'));
					die(require_once ("source/ports/templates/readfile.php"));
				}else {
					die(header("HTTP/1.1 503 Service Unavailable"));
				}
		...
		if (isset($g_user['mode']) && (!isset($_uri[1]) || (isset($_uri[1]) && is_string($_uri[1]) && in_array($_uri[1], ["", "general"])))) {
			if (isset($_uri[2]) && is_string($_uri[2]) && in_array($_uri[2], ["auto", "new", "action"])) $feedMethod = $_uri[2]; else $feedMethod = (isset($g_user['feed.order']['general']) && is_string($g_user['feed.order']['general'])) ? $g_user['feed.order']['general'] : null;
			$feed_['options'] = array(
				"type" => "general",
				"method" => $feedMethod
			);
		...
		*/
		...
		if (isset($_uri[1]) && is_string($_uri[1]) && $_uri[1] == "raw") {
			if (is_string($_uri[2]) && preg_match("/^(static)/i", $_uri[2])) {
				...
				$photosUrl = preg_replace("/(\.(jpg|png|gif|jpeg))(\S+)$/", "$1", $photosFile);
				$photosExt = pathinfo($photosUrl, PATHINFO_EXTENSION);
				$photosExt = isset($photosExt) && is_string($photosExt) && preg_match("/(jpg|jpeg|png|gif)/", $photosExt) ? $photosExt : "png";
			...
			if (isset($_uri[2]) && is_string($_uri[2])) $fileName = $_tool->convertDatabaseString(addslashes($_uri[2])); else $fileName = null;
			if ($fileName == null) {
				header("Content-type: image/gif");
				die(print "_");
			}
		...
		if (isset($_uri[1]) && is_string($_uri[1]) && in_array($_uri[1], [null, ""])) {
			...
			if ($fileName == "thumbnail") {
				if (isset($_uri[3]) && is_string($_uri[3])) $fileName = $_tool->convertDatabaseString($_uri[3]); else $fileName = null;
				if ($fileName == null) {
					die(require_once("source/ports/oops.php"));
				}
				$fileName = preg_replace("/(\.(jpg|png|gif|jpeg))(\S+)$/", "$1", $fileName);
