...
Class user {
		...
		if (isset($userProfile['username'], $userProfile['password'], $userProfile['email'], $userProfile['firstname'], $userProfile['lastname'], $userProfile['birthday']['days'], $userProfile['birthday']['months'], $userProfile['birthday']['years'], $userProfile['gender'])) {
			...
			if (!isset($userProfile['username']) || !is_string($userProfile['username']) || !preg_match($regex['username'], $userProfile['username'])) {
				...
				if (!$createUserQuery) {
					                                    ...
					                                    <tr>
					                                        <td>
					                                            <table style='min-width:300px' border='0' cellspacing='0' cellpadding='0'>
					                                                <tbody>
					                                                   	<div style='margin-top: 5px;'><span>Hi, ".$userProfile['fullname'].".</span></div>
					                                                   	<div style='margin-top: 5px;'>
						                                                   	<span>Someone used this email address to register your Giccos account.</span><br>
						                                                   	<span>Created at ".date('H:i, d/n/Y', $userProfile['time'])." (".date_timezone_get().").</span>
					                                                   	</div>
					                                                   	<div style='margin-top: 5px;'>
					...
					$mailerOptions = array(
						"type" => "support",
						"title" => $_language->text('mailer_verify_account_subject', 'normal'),
						"content" => $mailHTMLContent,
						"alt" => $_language->text('mailer_verify_account_altbody', 'normal'),
			...
			return array("return" => false, "reason" => "13");
		}
	}
	...
	function friexnds ($action, $object) {
