...
html.accounts.register #gBox > #centerBox > #registerBox > .body > .lines.birthday .input.birthday.year {
	width: 28%;
}
...
html.accounts.getpassword #gBox > #centerBox > #getpasswordBox > .body > .lines.quickinfo {
		
}
html.accounts.getpassword #gBox > #centerBox > #getpasswordBox > .body > .lines.quickinfo > .thumbnail .img {
	margin: 5px auto;
	width: 100px;
	height: 100px;
	border: none;
...
html.accounts.getpassword #gBox > #centerBox > #getpasswordBox > .body > .lines.quickinfo > .thumbnail .img img {
	display: none;
}
html.accounts.getpassword #gBox > #centerBox > #getpasswordBox > .body > .lines.quickinfo > .textinfo {
	
}
html.accounts.getpassword #gBox > #centerBox > #getpasswordBox > .body > .lines.quickinfo > .textinfo > div {
	text-align: left;
}
html.accounts.getpassword #gBox > #centerBox > #getpasswordBox > .body > .lines.quickinfo > .textinfo > div label {
	display: inline-block;
	margin-left: 16px;
	width: 40%;
	text-align: right;
}
html.accounts.getpassword #gBox > #centerBox > #getpasswordBox > .body > .lines.quickinfo > .textinfo > div span {
	margin-left: 0;
	color: #666;
	font-size: 13px;
	font-weight: 400;
