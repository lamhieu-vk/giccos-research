...
var browserNotification = function (object) {
	...
	if (isset(object['tab']) && typeof object['tab'] == "object") {
		...
		if (giccos.attr('handling-notify-tab') != "true") {
			...
			var newTitle = (isset(object['tab']['title']) && typeof object['tab']['title'] == "string") ? object['tab']['title'] : "";
...
var popupNotification = function (object) {
	...
	if (!isset(timeout) || timeout === null) {
		timeout = <?php print $_parameter->get("notifyPopup_timeout"); ?>;
	}
	...
	if (c_title !== null || c_description !== null || c_from !== null) {
		...
		if (global === true || audio !== false) {
			var browserNotifyObj = {};
			if (global === true) {
				browserNotifyObj['tab'] = {
					'title': t_title + ': ' + t_description.toLowerCase(),
					'timeout': 2000
				};
			}
			if (audio !== false) {
