...
#gEditor > .title > .list > .rows span {
	cursor: pointer;
	color: #999;
	font: normal normal 300 11px/2.4em "Roboto";
...
#gEditor > .box > .body[content] > .upload.photos .list .preview:nth-child(n+7) {
	margin: 2px 0;
}
...
#gEditor > .box > .body[content] > .upload.photos .action {
	margin-top: 4px;
}
#gEditor > .box > .body[content] > .upload.photos .action .button {
	position: relative;
    display: inline-block;
    vertical-align: top;
	cursor: pointer;
...
#gEditor > .box > .body[content] > .upload.photos .action .button:last-child {
	margin-right: 0;
}
#gEditor > .box > .body[content] > .upload.photos .action .button> i {
	position: absolute;
	color: #CCC;
	font: normal normal 300 28px/1em "FontAwesome";
	transition: color .5s ease;
}
#gEditor > .box > .body[content] > .upload.photos .action .button[upload] > i:before {
	content: "\f093";
}
#gEditor > .box > .body[content] > .upload.photos .action .button[select] > i:before {
	content: "\f07b";
}
#gEditor > .box > .body[content] > .upload.photos .action .button[remove] > i:before {
	content: "\f00d";
}
#gEditor > .box > .body[content] > .upload.photos .action .button.add > i {
	top: 12px;
	left: 12px;
}
#gEditor > .box > .body[content] > .upload.photos .action .button.remove > i {
	top: 12px;
	left: 12px;
}
#gEditor > .box > .body[content] > .upload.photos .action .button:hover {
	border-color: #AAA;
}
#gEditor > .box > .body[content] > .upload.photos .action .button:hover > i {
	color: #AAA;
}
...
#gEditor > .box > .footer > .push > .button.private .choosePrivate .selected > .rows > i {
	margin: 4px;
}
...
#PhotosEditorPopup > .boxContent > .header i[close]:hover {
	color: #666;
}
