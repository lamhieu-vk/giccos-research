...
<html lang="<?php print $g_client['language']['code']; ?>" id="giccos" class="feed status">
	<head>
		<title><?php if (isset($feed_['content']['title']) && $feed_['content']['title'] != null) { print $feed_['content']['title'].' :: '; } print $_language->text('feed_live.title', 'ucwords'); ?></title>
		...
		<div id="gMain">
			...
			<div id="gBox">
				...
				<div id="centerBox">
					...
					if (isset($feed_['exists']['live']) && $feed_['exists']['live'] == true) {
						$feed_['content']['code'] = "";
						...
						<div class='null inFeeds boxGrid'> 
							...
							<div class='description'><span>{$_language->text('not_found_info_live', 'ucfirst')}.</span></div> 
						</div>
						";
					}
					print "
					<div id='gFeeds' class='thisFeeds feed' feed='".json_encode($feed_['content']['this'])."'>
						<div class='info inFeeds boxGrid' class='thisTotal'>
							...
							<div class='description'>
								<span>{$_language->text('feed_live.quickdescription', 'ucfirst', false)}.</span>
							</div>
						</div>
						{$feed_['content']['code']}
