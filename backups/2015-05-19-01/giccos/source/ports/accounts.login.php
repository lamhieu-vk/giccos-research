			...
			<div id="gBox">
				...
				<div id="centerBox">
					<div id="headerBox">
						...
						<div class="lines desc"><span><?php print $_language->text('pages_accounts_login.desc', 'ucfirst'); ?></span></div>
					</div>
					<div id="loginBox" class="box">
						<div class="header"> <span><?php print $_language->text('login', 'ucfirst'); ?></span> </div>
						<div class="body">
							<!--
