	...
	function isCachedPage ($url = null) {
		...
		if (isset($_SESSION["cache"], $_SESSION["cache"]['page'])) {
			...
			if (isset($pageCached[$urlToken]) && is_array($pageCached[$urlToken]) && count($pageCached[$urlToken]) > 0) {
				...
				if (isset($pageCachedArr['called'], $pageCachedArr['type'], $pageCachedArr['length'], $pageCachedArr['etag'], $pageCachedArr['modified']) && $pageCachedArr['called'] > 3) {
					$_SESSION["cache"]['page'][$urlToken]['called']++;
					header("HTTP/1.1 304 Not Modified");
					header("Content-Type: ". $pageCachedArr['type']);
					header("Cache-Control: max-age=". $pageCachedArr['expire']);
