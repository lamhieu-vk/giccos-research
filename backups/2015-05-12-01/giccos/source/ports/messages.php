							...
							if ($activate > 0) {
								...
								<div id='gMessagesTab' class='boxGrid' view='{$messages_['code']['view']}'>
									<div class='title nowrap'>
										<span class='text'>{$_language->text('conversation_with', 'ucfirst', false)} {$messages_['tab']['data']['name']}</span>
										<a class='settings'></a>
									</div>
									<div class='main'>
										<div class='content'>
										...
										<div class='type'>
											<div class='input'><textarea class='ip_as' type='text' placeholder='{$_language->text('type_a_messages', 'ucfirst', false)}'></textarea></div>
											<div class='action'>
												<div class='scroll'>
													<div class='checkbox'>
														<input id='checkbox-autoscroll' type='checkbox'>
														<label for='checkbox-autoscroll'>{$_language->text('automatically_pulled_down', 'ucfirst', false)}</label>
													</div>
												</div>
												<div class='send'>
													<div class='checkbox'>
														<input id='checkbox-enter_send' type='checkbox'>
														<label for='checkbox-enter_send'>{$_language->text('press_enter_to_send', 'ucfirst', false)}</label>
													</div>
													<button class='_bn_c-we'>{$_language->text('send', 'ucfirst', false)}</button>
												</div>
											</div>
										</div>
									</div>
