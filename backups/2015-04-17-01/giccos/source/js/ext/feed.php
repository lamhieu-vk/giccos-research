		...
		if (type == "photos" && object != "" && object !== undefined && typeof JSON.parse(object) == 'object') {
			...
			if (object['type'] == 'music') {
				var box = $(this).parent('.media.MusicBox'),
					...
					c_media = '<audio id="'+object['id']+'" class="gplayer-skin video" controls preload="auto" width="98%" height="82px" data-setup="{}"> <source src="'+object['link']+'" type="'+object['mime']+'"> </audio>';
