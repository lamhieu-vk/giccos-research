...
html.messages.general #popupCreateMessages[status-invite] .box > .main > .content textarea,
html.messages.general #popupCreateMessages[status-invite] .box > .main > .content input {
	width: auto;
}
html.messages.general #popupCreateMessages[status-share] .box > .main > .content textarea,
html.messages.general #popupCreateMessages[status-share] .box > .main > .content input {
	width: 98%;
}
