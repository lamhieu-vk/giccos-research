		...
		<div class="footer">
			<div class="push">
				...
				<div class="button private">
					...
					<!-- <i class="_tt-bk s" editor-push="private" private-view="<?php print $privateView; ?>" private-comment="<?php print $privateComment; ?>" private-share="<?php print $privateShare; ?>" title="<small><?php print $_language->text('change_private', 'ucfirst'); ?></small>"></i> -->
					<?php
