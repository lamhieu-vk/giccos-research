...
var popupNotification = function (object) {
	...
	}else if (type == 3 || type == "news") {
		var c_type = "<i class='_t3 _tt-bk e' close title='"+tip+"'></i>";
	}else if (type == 4 || type == "warning") {
		var c_type = "<i class='_t4 _tt-bk e' close title='"+tip+"'></i>";
	}else {
		var c_type = "";
	}
	...
	if (!isset(description)) {
		...
		if (description_object === true) {
			if (isset(description['type']) && description['type'] == "info::places") {
				var data = description['data'];
				if (!isset(data['type']) || data['type'] === null) {
					var type = "";
				}else {
					// var type = "<span>"+data['type'].ucfirst()+": </span>";
					var type = "<span><?php print $_language->text('name', 'ucfirst'); ?>: </span>";
				}
				if (!isset(data['name']) || data['name'] === null) {
					var name = "";
				}else {
					var name = "<span>"+data['name'].ucfirst()+".</span>";
				}
				...
				if (!isset(data['location']) || data['location'] === null) {
					...
					var address = address + " <br> <span><?php print $_language->text('location', 'ucfirst'); ?>: "+data['location']+".</span>";
				}
			...
			if (popup.hasClass("_h")) {
				popup.removeClass("_h").slideDown('slow',function() {
					...
					if (isset(callback) && typeof callback == "function") {
						...
						$(this).addClass("cr-pointer").bind('click', function () {
	...
	*/
	...
	var pushData = function (infoObj) {
		...
		if (infoObj['type'] == "introduction") {
			var linesIntro = "<div class='lines introduction'> <label><?php print $_language->text('introduction', 'ucfirst'); ?></label> <div><textarea class='input introduction as' type='text' placeholder='<?php print $_language->text('write_something_about_intro', 'ucfirst'); ?>'></textarea></div> </div>";
			var linesQuote = "<div class='lines quote'> <label><?php print $_language->text('quote', 'ucfirst'); ?></label> <div><textarea class='input quote as' type='text' placeholder='<?php print $_language->text('write_favorite_quote', 'ucfirst'); ?>'></textarea></div> </div>";
			...
			var linesUsername = "<div class='lines username'> <label><?php print $_language->text('username', 'ucfirst'); ?></label> <div><input class='input username' type='text' placeholder='<?php print $_language->text('username', 'strtolower'); ?>' disabled='disabled'></div> </div>";
			var linesName = "<div class='lines name'> <label><?php print $_language->text('name', 'ucfirst'); ?></label> <div><input class='input name firstname' type='text' placeholder='<?php print $_language->text('firstname', 'strtolower'); ?>'> <input class='input name middlename' type='text' placeholder='<?php print $_language->text('middlename', 'strtolower'); ?>'> <input class='input name lastname' type='text' placeholder='<?php print $_language->text('lastname', 'strtolower'); ?>'></div> <div><input class='input fullname' type='text' placeholder='<?php print $_language->text('fullname', 'strtolower'); ?>' disabled='disabled'> <input class='input nickname' type='text' placeholder='<?php print $_language->text('nickname', 'strtolower'); ?>'></div> </div>";
			...
			var linesBirthday = "<div class='lines birthday'> <label><?php print $_language->text('birthday', 'ucfirst'); ?></label> <div> <input class='input birthday day' date-type='day' type='text' placeholder='<?php print $_language->text('day', 'strtolower'); ?>'> <input class='input birthday month' date-type='month' type='text' placeholder='<?php print $_language->text('month', 'strtolower'); ?>'> <input class='input birthday year' date-type='year' type='text' placeholder='<?php print $_language->text('year', 'strtolower'); ?>'> </div> </div>";
			var linesLanguage = "<div class='lines language'> <label><?php print $_language->text('language', 'ucfirst'); ?></label> <div><input class='input language' type='text' placeholder='<?php print $_language->text('language', 'strtolower'); ?>'></div> </div>";
			...
			var linesImportant = "<div class='lines important'> <label><?php print $_language->text('important', 'ucfirst'); ?></label> <div class='email'><input class='input email' type='text' placeholder='<?php print $_language->text('email', 'upperlower'); ?>'><div class='private _tt-bk s' title='<small><?php print $_language->text('change_private', 'ucfirst'); ?></small>'></div></div> <div class='phone'><input class='input phone' type='text' placeholder='<?php print $_language->text('phone', 'upperlower'); ?>'> <div class='private _tt-bk s' title='<small><?php print $_language->text('change_private', 'ucfirst'); ?></small>'></div> </div> </div>";
			...
			var actionTypeInputPhone = function () {
				var addButton = mainBox.find(".lines.phone .add > .addbutton");
			...
			var addPhoneContact = function () {
				...
				addButton.bind('click', function () {
					...
					var randkey = randomKeyString(10);
					mainBox.find(".lines.phone > .add").before('<div class="textinfo" randkey="'+randkey+'"> <input class="input phone _tt-bk s" type="text" placeholder="<?php print $_language->text('type_phonenumber', 'upperlower'); ?>"> <div class="private" title="<small><?php print $_language->text('change_private', 'ucfirst'); ?></small>"></div></div>');
			...
			var actionTypeInputEmail = function () {
				var addButton = mainBox.find(".lines.email .add > .addbutton");
			...
			if (isset(infoObj['data']['contact']) && countArr(infoObj['data']['contact']) > 0) {
				contactLoop: for (var i in infoObj['data']['contact']) {
					...
					if (isset(thisContact['type']) && thisContact['type'] == "email") {
						...
						mainBox.find(".lines.email > .add").before('<div class="textinfo" contact-id="'+thisContact['id']+'"> <input class="input email _tt-bk s" type="text" placeholder="<?php print $_language->text('email', 'upperlower'); ?>" value="'+thisContact['value']+'"> <div class="private" title="<small><?php print $_language->text('change_private', 'ucfirst'); ?></small>"></div> </div>');
						...
						mainBox.find(".lines.phone > .add").before('<div class="textinfo" contact-id="'+thisContact['id']+'"> <input class="input phone _tt-bk s" type="text" placeholder="<?php print $_language->text('phone', 'upperlower'); ?>" value="'+thisContact['value']+'"> <div class="private" title="<small><?php print $_language->text('change_private', 'ucfirst'); ?></small>"></div></div>');
