...
function PhotosTagPopup (object) {
	...
	function pushTagFaces (faces) {
		for (var i in faces) {
			...
			var codeTags = " <div class='thisTag faces "+tagClass+"' tag-name='"+tagClass+"' tag-height='"+tagHeight+"' tag-width='"+tagWidth+"' ratio-height='"+thisFace['ratio']['height']+"' ratio-width='"+thisFace['ratio']['width']+"' position-x='"+positionX+"' position-y='"+positionY+"' info='"+JSON.stringify(thisFace)+"'></div> ";
