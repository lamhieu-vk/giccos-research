...
if (isset($existsVideoThis, $existsVideoThis['return'], $existsVideoThis['exists']) && $existsVideoThis['return'] == true) {
	if ($existsVideoThis['exists'] == true) {
		...
		if (isset($fetchVideoThis, $fetchVideoThis['return'], $fetchVideoThis['data'], $fetchVideoThis['data'][0]) && $fetchVideoThis['return'] == true) {
			...
			$getGuyVideo = $_media->guy(array("author" => $videoInfoArr['author'], "guy" => $g_user['mode']));
							...
							<div class="content">
								<div class="tab left">
									...
									<div class="rows description">
										<div class="value"> <span><?php print $_tool->parseContent($videoInfoArr['description']); ?></span> </div>
									</div>
								</div>
								<div class="tab right">
									<div class="rows time">
							...
							<div class="content">
								<div class="rows table">
									<div class="value views"> 
										...
										_dataCache.add("videos_info_stats_views_dataset", datasetOptions);
										</script>
									</div>
									<div class="value mention"> 
										...
										_dataCache.add("videos_info_stats_mention_dataset", datasetOptions);
										</script>
									</div>
									<div class="value">
										<div class="statsTip"> 
