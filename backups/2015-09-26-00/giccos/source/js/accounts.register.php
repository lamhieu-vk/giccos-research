var actionBoxRegister = function () {
	var resizeCenterSubBox = function (){
		...
		headerBox.css({
			'margin-top': (($(window).height() / 2 - registerBox.innerHeight() / 2) - headerBox.innerHeight()) / 2 + 'px'
		});
		registerBox.css({
			'margin-top': (($(window).height() / 2 - registerBox.innerHeight() / 2) - headerBox.innerHeight()) / 2 + 'px'
		});
...
var registerAccounts = function () {
	...
	var actionRegisterAccounts = function () {
		...
		if (!usernameRegex(inputUsername.val())) {
			...
			popupNotification ({type: 'error', title: '<?php print $_language->text('error', 'ucfirst'); ?>', description: "<?php print $_language->text('username_is_invalid', 'ucfirst'); ?>, <?php print $_language->text('please_recheck', 'strtolower'); ?>.", timeout: '<?php print $_parameter->get('notifyPopup_timeout'); ?>'});
			...
			popupNotification ({type: 'error', title: '<?php print $_language->text('error', 'ucfirst'); ?>', description: "<?php print $_language->text('password_is_invalid', 'ucfirst'); ?>, <?php print $_language->text('please_recheck', 'strtolower'); ?>.", timeout: '<?php print $_parameter->get('notifyPopup_timeout'); ?>'});
		}else if (inputUsername.val() == inputPassword.val()) {
			inputPassword.parents(".password").addClass("error");
			setTimeout(function(){
				inputPassword.parents(".password").removeClass("error");
			}, 3000);
			popupNotification ({type: 'error', title: '<?php print $_language->text('error', 'ucfirst'); ?>', description: "<?php print $_language->text('less_secure_password', 'ucfirst'); ?>, <?php print $_language->text('please_recheck', 'strtolower'); ?>.", timeout: '<?php print $_parameter->get('notifyPopup_timeout'); ?>'});
		}else if (!emailRegex(inputEmail.val())) {
			inputEmail.parents(".email").addClass("error");
			setTimeout(function(){
				inputEmail.parents(".email").removeClass("error");
			}, 3000);
			popupNotification ({type: 'error', title: '<?php print $_language->text('error', 'ucfirst'); ?>', description: "<?php print $_language->text('email_is_invalid', 'ucfirst'); ?>, <?php print $_language->text('please_recheck', 'strtolower'); ?>.", timeout: '<?php print $_parameter->get('notifyPopup_timeout'); ?>'});
			...
			popupNotification ({type: 'error', title: '<?php print $_language->text('error', 'ucfirst'); ?>', description: "<?php print $_language->text('name_is_invalid', 'ucfirst'); ?>, <?php print $_language->text('please_recheck', 'strtolower'); ?>.", timeout: '<?php print $_parameter->get('notifyPopup_timeout'); ?>'});
			...
			popupNotification ({type: 'error', title: '<?php print $_language->text('error', 'ucfirst'); ?>', description: "<?php print $_language->text('birthday_is_invalid', 'ucfirst'); ?>, <?php print $_language->text('please_recheck', 'strtolower'); ?>.", timeout: '<?php print $_parameter->get('notifyPopup_timeout'); ?>'});
			...
			popupNotification ({type: 'error', title: '<?php print $_language->text('error', 'ucfirst'); ?>', description: "<?php print $_language->text('gender_is_invalid', 'ucfirst'); ?>, <?php print $_language->text('please_recheck', 'strtolower'); ?>.", timeout: '<?php print $_parameter->get('notifyPopup_timeout'); ?>'});
			...
			popupNotification ({type: 'error', title: '<?php print $_language->text('error', 'ucfirst'); ?>', description: "<?php print $_language->text('repassword_wrong', 'ucfirst'); ?>, <?php print $_language->text('please_recheck', 'strtolower'); ?>.", timeout: '<?php print $_parameter->get('notifyPopup_timeout'); ?>'});
			...
			popupNotification ({type: 'error', title: '<?php print $_language->text('error', 'ucfirst'); ?>', description: "<?php print $_language->text('agree_is_not_check', 'ucfirst'); ?>, <?php print $_language->text('please_recheck', 'strtolower'); ?>.", timeout: '<?php print $_parameter->get('notifyPopup_timeout'); ?>'});
		}else {
			...
			var sendRequestFunc = function () {
				var doneRequestFunc = function () {
					var wrapperLoadCallback = function () {
						console.log($(this).parents("#wrapperLoading"));
						$(this).parents("#wrapperLoading").fadeOut(function () {
							$(this).remove();
						});
					};
					wrapperLoad.remove({'randkey': keyEventLoad, 'callback': wrapperLoadCallback});
				...
				var requestAction = $.ajax({
					...
					success: function(data) {
						if (isset(data['return']) && data['return'] === true) {
							...
							popupNotification ({type: 'error', title: '<?php print $_language->text('error', 'ucfirst'); ?>', description: ".", audio: true, timeout: 6000});
						}else {
							popupNotification ({type: 'error', title: '<?php print $_language->text('error', 'ucfirst'); ?>', description: "<?php print $_language->text('undefined', 'ucfirst'); ?>.", timeout: 6000});
						}
					}
				}).fail(doneRequestFunc).done(doneRequestFunc);
			};
			var wrapperLoadOpenFunc = function (e) {
				popupNotification ({type: "notification", title: "<?php print $_language->text('notification', 'ucfirst'); ?>", description: "<?php print $_language->text('request_begin_please_wait', 'ucfirst'); ?>.", timeout: 3000});
				sendRequestFunc();
			};
			wrapperLoad.add({'randkey': keyEventLoad, 'openCallback': wrapperLoadOpenFunc, 'close': false});
		}
	};
